...
enum class FileDialogMode(
    ...
    fun selectFiles(extensions: Iterable<String>? = null): List<String> {
        // TinyFileDialogs is backed by a desktop native library which is not
        // available on Android (PojavLauncher/ZalithLauncher). File picking is
        // therefore not supported there and gracefully returns no selection.
