...
public final class LiquidInstruction {
    ...
    try {
      return System.getenv("ANDROID_ROOT") != null
          || (System.getProperty("java.vendor") != null
              && System.getProperty("java.vendor").toLowerCase().contains("pojav"));
    } catch (Exception e) {
      return false;
    }
  }
  ...
  public static void main(String[] args) {
    // This Swing based launcher helper is not available on Android
    // (PojavLauncher/ZalithLauncher run the mod through Fabric instead).
    if (isAndroid()) {
      System.err.println("LiquidBounce is a Fabric mod; install it through your launcher (e.g. PojavLauncher/ZalithLauncher) together with Fabric and Fabric API.");
      return;
    }
